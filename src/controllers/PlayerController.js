...
module.exports = (overwatch, oversmash, firebase) => {
  const module = {};
   ...
   */
  module.getOutdatedPlayers = async () => {
   ...
   * @param {String} platform Player's platform
   */
  module.updatePlayer = async (tag, platform) => {
   ...
   */
  module.getFollowing = async (req, res) => {
   ...
   * @param {String} res HTTP response data
   */
  module.followPlayer = async (req, res) => {
    const token = req.headers.authorization;
